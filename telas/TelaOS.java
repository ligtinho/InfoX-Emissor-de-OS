...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    // a linha abaixo cria uma váriavel para armazenar um texto de acordo com o radio button selecionado
    private String tipo;
    ...
    private void pesquisar_cliente() {
        ...
        try {
            ...
            // passando o conteúdo da caixa de pesquisa txtCliPesquisar para o ?
    ...
    private void emitir_os() {
        ...
        try {
            ...
            // o código .replace substitui a vírgula pelo ponto
            ...
            if ((cboOsSit.getSelectedItem().equals(" ")) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty()) || (txtCliId.getText().isEmpty())) {
                ...
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "OS/orçamento emitido com sucesso");
                    //chamando o método recuperar Os
                    recuperarOs();
    ...
    private void alterar_os() {
        ...
        try {
            ...
            if ((cboOsSit.getSelectedItem().equals(" ")) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty()) || (txtCliId.getText().isEmpty())) {
                ...
                //System.out.println(adicionado);
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "OS/orçamento alterado com sucesso");
                    limpar();
                }
            }
    ...
    private void deletar_os() {
        ...
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja deletar a OS?", "Atenção", JOptionPane.YES_NO_OPTION);
    ...
    private void imprimir_os() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                // a linha abaixo exibe o relatório atravé da classe JasperViewer
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Cliente                                                           *Campos obrigatórios"));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtOsValor, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE))
